...
use super::{
    constants::K256,
    util::{load_u32_be, memcpy, memset, store_u32_be, store_u64_be},
};
...
macro_rules! sha {
    (
        ...
        #[derive(Clone)]
        pub(in crate::sha2_const) struct $name {
            state: [$word; 8],
        ...
        impl $name {
            pub(in crate::sha2_const) const BLOCK_SIZE: usize = 16 * Self::WORD_SIZE;
            ...
            pub(in crate::sha2_const) const fn new(state: [$word; 8]) -> Self {
                Self {
                    state,
            ...
            pub(in crate::sha2_const) const fn update(&mut self, input: &[u8]) {
            ...
            pub(in crate::sha2_const) const fn finalize(mut self) -> [u8; Self::DIGEST_SIZE] {
