...
use object_rainbow::{HASH_SIZE, Hash, InlineOutput, ListHashes, Tagged, ToOutput, pod};

const LENGTH: usize = HASH_SIZE * 8;

#[derive(Debug, ToOutput, InlineOutput, Tagged, ListHashes, Clone, Copy, PartialEq, Eq)]
